package org.desviante.codeorganization.functionaldecomposition.CheckingDivisibilityAndPrintingAppropriateStrings;
...
public class Main {
    ...
    private static boolean isDivByThreeAndFive(int number){
        return isDivByThree(number) && isDivByFive(number);
    }
}
